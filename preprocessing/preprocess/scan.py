...
import sys
sys.path.append('/home/tranquangphu/AutoCrawler/preprocessing/preprocess')
...
class DocScanner(object):
    ...
    def scan(self, image, output_path=None, binary=False):
        ...
        ratio = cv2.imread(image).shape[0] / RESCALED_HEIGHT
        orig = cv2.imread(image).copy()
        ...
        if output_path is not None:
            ...
            file_name = f"/home/tranquangphu/KOR_OCR/data/{random.randint(0, 1000000)}.png"
