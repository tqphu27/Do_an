...
def draw_ocr_box_txt(image,
    ...
    for idx, (box, txt) in enumerate(zip(boxes, txts)):
        ...
        if box_height > 2 * box_width:
            ...
            font = ImageFont.truetype('/home/tima/Do_an/api/models/kor.ttf', font_size, encoding="utf-8")
            cur_y = box[0][1]
            for c in txt:
            ...
            font = ImageFont.truetype('/home/tima/Do_an/api/models/vi_font.ttf', font_size, encoding="utf-8")
            draw_right.text(
...
def init_args():
    ...
    parser.add_argument("--rec_model_dir", type=str, default='/home/tima/Do_an/api/models/oonx/model_rec.onnx')
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default="/home/tima/Do_an/api/models/korean_dict.txt")
    ...
    parser.add_argument('-output', '--output_folder', default='predict_results', type=str,
...
keys_vocab_cls = ClassVocab(Path(__file__).parent.joinpath('/home/tima/Do_an/api/models/kor_dict.txt'), specials_first=False)
iob_labels_vocab_cls = ClassVocab(entities2iob_labels(Entities_list), specials_first=False)
